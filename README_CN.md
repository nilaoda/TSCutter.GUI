...
内置运行时来源： [nilaoda/FFmpegSharedLibraries](https://github.com/nilaoda/FFmpegSharedLibraries/releases/latest)。TSCutter.GUI 发布包所使用的 Windows x64、Linux x64 和 macOS arm64 的 FFmpeg 共享库都统一由这个仓库维护。
